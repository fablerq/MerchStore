...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vform__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_examples_ExampleCrudUsers_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_examples_ExampleCrudUsers_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_examples_ExampleCrudUsers_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_examples_ExampleCrudOrders_vue__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_examples_ExampleCrudOrders_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_examples_ExampleCrudOrders_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_examples_ExampleCrudProducts_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_examples_ExampleCrudProducts_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_examples_ExampleCrudProducts_vue__);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  routes: [{
    path: '/example_users',
    name: 'users',
    component: __WEBPACK_IMPORTED_MODULE_5__components_examples_ExampleCrudUsers_vue___default.a
  }, {
    path: '/example_products',
    name: 'products',
    component: __WEBPACK_IMPORTED_MODULE_7__components_examples_ExampleCrudProducts_vue___default.a
  }, {
    path: '/example_orders',
    name: 'orders',
    component: __WEBPACK_IMPORTED_MODULE_6__components_examples_ExampleCrudOrders_vue___default.a
  }]
});
...
var render = function() {
  ...
  return _c("div", [
    _c("h1", [_vm._v("The best store ever")]),
    _vm._v(" "),
    _c(
      "p",
      [
        _c("router-link", { attrs: { to: { name: "app" } } }, [_vm._v("Home")]),
        _vm._v(" |\n    "),
        _c("router-link", { attrs: { to: { name: "users" } } }, [
          _vm._v("ExampleCrudUsers")
        ]),
        _vm._v(" "),
        _c("router-link", { attrs: { to: { name: "products" } } }, [
          _vm._v("ExampleCrudProducts")
        ]),
        _vm._v(" "),
        _c("router-link", { attrs: { to: { name: "orders" } } }, [
          _vm._v("ExampleCrudOrders")
        ])
      ],
      1
    ),
...
Component.options.__file = "resources/js/components/examples/ExampleCrudUsers.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67e7dcea", Component.options)
  } else {
    hotAPI.reload("data-v-67e7dcea", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vform__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        showUser: function showUser(id) {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('api/users/' + id).then(function (resp) {
                app.$router.replace('/');
            });
        ...
        deleteUser: function deleteUser(id) {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('api/users/' + id).then(function (resp) {
                app.$router.replace('/');
            });
            this.users = this.users.filter(function (user) {
                return user.id !== id;
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("p", [
      _vm._v(
        "Валидации нет. Потому осторожней. Везде уникальные поля + status_id это намбер. Пароль это hash"
      )
    ]),
    _vm._v(" "),
    _c(
    ...
    _c("div", { staticClass: "card-body" }, [
      _c(
        "form",
        {
          attrs: { action: "./api/users", method: "POST" },
          on: {
        ...
        [
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              domProps: { value: _vm.status_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.status_id = $event.target.value
                }
              }
            })
          ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-67e7dcea", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/examples/ExampleCrudOrders.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-51dda372", Component.options)
  } else {
    hotAPI.reload("data-v-51dda372", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("div", [
      ...
      [
        ...
        _vm._l(_vm.orders, function(order) {
          return _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(order.user.login) + " ")]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(order.is_paid))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(order.final_price))]),
            _vm._v(" "),
    ...
    _c("div", { staticClass: "card-body" }, [
      _c(
        "form",
        {
          attrs: { action: "./api/orders", method: "POST" },
          on: {
            submit: function($event) {
              _vm.addOrder()
            }
        ...
        [
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text", name: "user_id", placeholder: "user_id" },
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text", name: "is_paid", placeholder: "is_paid" },
              domProps: { value: _vm.is_paid },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.is_paid = $event.target.value
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.final_price,
                  expression: "final_price"
                }
              ],
              staticClass: "form-control",
              attrs: {
              ...
              domProps: { value: _vm.final_price },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.final_price = $event.target.value
                }
              }
            })
          ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("tr", [
      _c("td", [_vm._v("id")]),
      _vm._v(" "),
      _c("td", [_vm._v("product_id")]),
      _vm._v(" "),
      _c("td", [_vm._v("user_id")]),
      _vm._v(" "),
      _c("td", [_vm._v("is_paid")]),
      _vm._v(" "),
      _c("td", [_vm._v("final_price")]),
      _vm._v(" "),
      _c("td", [_vm._v("created_at")]),
      _vm._v(" "),
      _c("td", [_vm._v("updated_at")]),
      _vm._v(" "),
      _c("td", [_vm._v("show")]),
      _vm._v(" "),
      _c("td", [_vm._v("delete")])
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c("input", {
        staticClass: "btn btn-info",
        attrs: { type: "submit", value: "Add Order" }
      })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-51dda372", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/examples/ExampleCrudProducts.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b7ff1d9e", Component.options)
  } else {
    hotAPI.reload("data-v-b7ff1d9e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteProduct: function deleteProduct(id) {
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.delete('api/products/' + id).then(function (resp) {
                app.$router.replace('/');
            });
            this.products = this.products.filter(function (product) {
                return product.id !== id;
  ...
  return _c("div", [
      ...
      [
        ...
        _vm._l(_vm.products, function(product) {
          return _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(product.thumbnail))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(product.faculty.name) + " ")]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(product.type.name))]),
            _vm._v(" "),
            _c("td", [_vm._v(_vm._s(product.faculty.color))]),
            _vm._v(" "),
            _c("td", [
              _c(
                "a",
    ...
    _c("div", { staticClass: "card-body" }, [
      _c(
        "form",
        {
          attrs: { action: "./api/products", method: "POST" },
          on: {
            submit: function($event) {
              _vm.addProduct()
            }
        ...
        [
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text", name: "status", placeholder: "status" },
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              domProps: { value: _vm.faculty_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.faculty_id = $event.target.value
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "form-group" }, [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "text", name: "type_id", placeholder: "type_id" },
              domProps: { value: _vm.type_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.type_id = $event.target.value
                }
              }
            })
          ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("tr", [
      ...
      _vm._v(" "),
      _c("td", [_vm._v("faculty_id")]),
      _vm._v(" "),
      _c("td", [_vm._v("type_id")]),
      _vm._v(" "),
      _c("td", [_vm._v("color")]),
      _vm._v(" "),
      _c("td", [_vm._v("show")]),
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c("input", {
        staticClass: "btn btn-info",
        attrs: { type: "submit", value: "Add Product" }
      })
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b7ff1d9e", module.exports)
  }
}
