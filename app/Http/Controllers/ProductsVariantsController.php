...
class ProductsVariantsController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json($productsvariants, 200, ['Content-Type' => 'application/json;charset=utf8'], JSON_UNESCAPED_UNICODE);
    }
    ...
    public function show($id)
    {
        ...
        return response()->json($productsvariant, 200, ['Content-Type' => 'application/json;charset=utf8'], JSON_UNESCAPED_UNICODE);
    }
